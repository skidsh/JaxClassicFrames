...
function JcfTotemFrameMixin:OnLoad()
	self:RegisterEvent("PLAYER_TOTEM_UPDATE");
	self:RegisterEvent("PLAYER_ENTERING_WORLD");
	self:RegisterEvent("UPDATE_SHAPESHIFT_FORM");
	self:RegisterEvent("PLAYER_TALENT_UPDATE");	
	self:RegisterEvent("PLAYER_SPECIALIZATION_CHANGED"); 
	self.totemPool = CreateFramePool("BUTTON", self, "JcfTotemButtonTemplate");
end

function JcfTotemFrameMixin:Update()
...
function JcfTotemFrameMixin:OnEvent(event, ...)
	self:Update();
end

JcfTotemButtonMixin = { }; 
function JcfTotemButtonMixin:OnClick(mouseButton)
...
function JcfTotemButtonMixin:OnLoad()
...
function JcfTotemButtonMixin:OnUpdate(elapsed)
...
function JcfTotemButtonMixin:OnEnter()
	GameTooltip:SetOwner(self, "ANCHOR_BOTTOMRIGHT");
	GameTooltip:SetTotem(self.slot);
end

function JcfTotemButtonMixin:Update(startTime, duration, icon)
