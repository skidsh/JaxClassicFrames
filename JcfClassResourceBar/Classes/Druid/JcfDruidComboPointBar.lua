JcfDruidComboPointBarMixin = {};

function JcfDruidComboPointBarMixin:ShouldShowBar()
	local showBar = false;
...
function JcfDruidComboPointBarMixin:UpdatePower()
...
JcfDruidComboPointMixin = {};

function JcfDruidComboPointMixin:Setup()
	self.isActive = nil;
	self:ResetVisuals();
	self:Show();
end

function JcfDruidComboPointMixin.OnRelease(framePool, self)
	self:ResetVisuals();
	FramePool_HideAndClearAnchors(framePool, self);
end

function JcfDruidComboPointMixin:SetActive(isActive)
...
function JcfDruidComboPointMixin:ResetVisuals()
