...
JcfClassResourceBarMixin = {};

function JcfClassResourceBarMixin:OnLoad()
...
function JcfClassResourceBarMixin:OnEvent(event, arg1, arg2)
...
function JcfClassResourceBarMixin:HandleBarSetup()
...
function JcfClassResourceBarMixin:Setup()
	local showBar = false;
	...
	-- Custom scale for each implementation
	self:SetScale(self.customScale)
...
function JcfClassResourceBarMixin:UpdateMaxPower()
...
function JcfClassResourceBarMixin:UpdatePower()
